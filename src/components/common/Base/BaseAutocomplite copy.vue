	...
	<div class="base-autocomplite-wrapper" :class="{ 'invalid': error }">
		<label>
			...
			<div class="input-container">
				...
				<HeroIcon v-if="!multiple && selectedItems.length && selectedItems[0].icon" :name="selectedItems[0].icon" size="1.4em"></HeroIcon>
				<HeroIcon v-else-if="prependIcon" :name="prependIcon" size="16" fill="currentColor"></HeroIcon>
				<input
					type="text"
...
display: inline-block;
	...
	// background-image:
	//   url('@/assets/images/place-contacts.svg'),
